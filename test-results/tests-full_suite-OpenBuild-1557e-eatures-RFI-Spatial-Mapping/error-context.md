...
- Name: tests/full_suite.spec.js >> OpenBuilder Full Suite - Advanced Features >> RFI Spatial Mapping
- Location: tests/full_suite.spec.js:46:3
...
Call log:
  - navigating to "/index.php?page=rfi_map&lang=en", waiting until "load"
