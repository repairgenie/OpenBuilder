...
- Name: tests/full_suite.spec.js >> OpenBuilder Full Suite - Advanced Features >> AI Risk Heatmap & Predictions
- Location: tests/full_suite.spec.js:88:3
...
Call log:
  - navigating to "/index.php?lang=en", waiting until "load"
