...
- Name: tests/full_suite.spec.js >> OpenBuilder Full Suite - Advanced Features >> Budget Scenario Simulator
- Location: tests/full_suite.spec.js:15:3
...
Call log:
  - navigating to "/index.php?page=budget&lang=en", waiting until "load"
