...
- Name: tests/full_suite.spec.js >> OpenBuilder Full Suite - Advanced Features >> Administrative Audit Trail
- Location: tests/full_suite.spec.js:95:3
...
Call log:
  - navigating to "/index.php?page=audit_logs&lang=en", waiting until "load"
