...
- Name: tests/full_suite.spec.js >> OpenBuilder Full Suite - Advanced Features >> MFA Verification Flow
- Location: tests/full_suite.spec.js:68:3
...
Call log:
  - navigating to "/index.php?page=mfa&lang=en", waiting until "load"
