...
- Name: tests/full_suite.spec.js >> OpenBuilder Full Suite - Advanced Features >> Project Settings Persistence
- Location: tests/full_suite.spec.js:54:3
...
Call log:
  - navigating to "/index.php?page=project_settings&lang=en", waiting until "load"
